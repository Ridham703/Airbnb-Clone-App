...
const HeaderLogo = () => {
  return (
    <Link
      to={ROUTES.LISTING}
      className="flex items-center gap-2 text-airbnb-rausch focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-airbnb-rausch rounded-md p-1"
  ...
  return (
    <button
      ...
      className="hidden md:flex items-center border border-border-default rounded-full py-2 pl-6 pr-2 
        shadow-card hover:shadow-card-hover transition-all duration-200 cursor-pointer 
        focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-airbnb-rausch group"
    ...
    <div className="flex items-center gap-2 relative" ref={menuRef}>
      ...
      <button
        ...
        className="text-sm font-semibold text-text-primary hover:bg-bg-secondary rounded-full px-4 py-2.5 
          transition-colors cursor-pointer focus-visible:outline-2 focus-visible:outline-airbnb-rausch hidden sm:block"
      >
        Airbnb your home
      </button>
      ...
      <button
        ...
        className="p-2.5 hover:bg-bg-secondary rounded-full text-text-primary 
          transition-colors cursor-pointer focus-visible:outline-2 focus-visible:outline-airbnb-rausch flex items-center justify-center"
      >
      ...
      <button
        ...
        className="flex items-center border border-border-default rounded-full py-1.5 px-3 gap-3 
          hover:shadow-card-hover transition-all duration-200 cursor-pointer bg-white 
      ...
      {isMenuOpen && (
        <div
          className="absolute right-0 top-full mt-2 w-60 bg-white border border-border-light 
            rounded-2xl shadow-dropdown py-2 z-50 animate-[fadeIn_150ms_ease]"
          role="menu"

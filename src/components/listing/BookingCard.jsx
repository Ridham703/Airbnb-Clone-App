    ...
    <aside aria-label="Booking reservation card" className="relative">
      <div className="sticky top-28 border border-border-default rounded-2xl p-6 shadow-card bg-white space-y-6">
        ...
        <div className="border border-border-dark rounded-xl overflow-hidden text-xs">
          ...
          <div className="grid grid-cols-2 border-b border-border-dark divide-x divide-border-dark">
            <div className="p-3 bg-white">
              ...
              <input
                ...
                className="w-full mt-0.5 text-xs text-text-primary outline-none bg-transparent cursor-pointer"
          ...
          <div className="relative p-3 bg-white cursor-pointer" onClick={() => setIsGuestOpen((prev) => !prev)}>
            <label className="block font-bold uppercase text-[10px] text-text-primary">
              GUESTS
            </label>
            <div className="flex items-center justify-between mt-0.5 text-xs text-text-primary font-medium">
              <span>{guestsCount} guest{guestsCount > 1 ? "s" : ""}</span>
              <svg viewBox="0 0 32 32" className={`w-3.5 h-3.5 transition-transform ${isGuestOpen ? "rotate-180" : ""}`}>
            ...
            {isGuestOpen && (
              <div
                className="absolute left-0 right-0 top-full mt-1 bg-white border border-border-default rounded-xl p-4 shadow-dropdown z-30 space-y-3"
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="w-7 h-7 rounded-full border border-border-dark flex items-center justify-center text-sm font-bold disabled:opacity-30"
                    >
                      -
                    </button>
        ...
        <button
          ...
          className="w-full py-3.5 rounded-xl text-white font-semibold text-base
            ...
            hover:opacity-95 transition-all duration-200 active:scale-[0.98] shadow-md cursor-pointer"
        >
